          ...
          render={({ field }) => (
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value="Occasionally Smoking">Occasionally Smoking</MenuItem>
                <MenuItem value="Occasionally Drinking">Occasionally Drinking</MenuItem>
              </Select>
            </FormControl>
          )}
        />
                    ...
                    {uploadedDoc ? (
                      <Box>
                        <Chip 
                          ...
                          sx={{ mr: 1 }}
                        />
                        {uploadedDoc.status === 'REJECTED' && uploadedDoc.rejectedReason && (
                          <Typography variant="caption" display="block" color="error" sx={{ mt: 0.5 }}>
                            Reason: {uploadedDoc.rejectedReason}
                          </Typography>
                        )}
